...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        #compute the input matrix of source sentence with shape (src_len,b,e)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        #Apply attention projection , compute the inpute matrix of decoder
        ...
        #Stack cobined output into one 3D tensor
